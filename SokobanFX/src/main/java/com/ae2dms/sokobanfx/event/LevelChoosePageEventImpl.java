...
/**
 * This class implements the LevelChoosePageEvent interface to handle all the events on the Choose
 * Level page.
 *
 ...
 * @version 1.0
 */
public class LevelChoosePageEventImpl implements LevelChoosePageEvent {
  private static LevelChoosePageEventImpl instance = new LevelChoosePageEventImpl();
  FileManager fileManager = FileManager.getInstance();
  GridManager gridManager = GridManager.getInstance();
  PlayPageController playPageController;

  private LevelChoosePageEventImpl() {}

  /**
   * This is the getter for getting the only object available.
   *
   * @return The only available of LevelChoosePageEventImpl object.
   */
  public static LevelChoosePageEventImpl getInstance() {
    return instance;
  }
   ...
   */
  @Override
  public void gotoLevel(int index, Stage primaryStage) {
    ...
    try {
      ...
      gridManager.setLevelIndex(index);
      gridManager.setLevelChoose(true);
